...
fancon is a C++ userspace fan control tool, allowing custom speed-temperature curve for each invdividual fan, controllable by either PWM or RPM.

  - High performance
  - Low memory usage

Low overhead and easy configuration are the main goals of fancon, this is achived by:
...
$ sudo apt-get install lm-sensors rsyslog build-essentials cmake libsensors4-dev libboost-filesystem-dev libexplain-dev
